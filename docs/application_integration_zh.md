...
- 应用执行器：[`include/robot/service/command_executor.h`](../include/robot/service/command_executor.h)
- 命令执行实现：[`src/service/command_executor.cc`](../src/service/command_executor.cc)
- 安全校验：[`src/safety/command_guard.cc`](../src/safety/command_guard.cc)
- 驱动抽象：[`include/robot/driver/robot_driver.h`](../include/robot/driver/robot_driver.h)
