#ifndef ROBOT_CONTROL_ROBOT_SERVICE_H_
#define ROBOT_CONTROL_ROBOT_SERVICE_H_
#include <cstdint>
#include <string>
#include <vector>
...
class RobotService {
 public:
  ...
  virtual StatusOr<ControlLease> RenewControlLease(const std::string&,
                                                   const std::string&) = 0;
  virtual Status ReleaseControlLease(const std::string&,
                                     const std::string&) = 0;
...
#endif  // ROBOT_CONTROL_ROBOT_SERVICE_H_
